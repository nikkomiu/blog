...
If you run into any issues, you can check the logs of the Dev Container. The log will typically open on failure, but if
it doesn't, you can open it by running the `Dev Containers: Show Container Log` command from the Command Palette.

## _(Optional)_ Add Dev Container README
...
## _(Optional)_ Add Trivy Support
